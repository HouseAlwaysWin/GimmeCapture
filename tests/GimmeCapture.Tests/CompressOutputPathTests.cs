...
public class CompressOutputPathTests
{
    ...
    public void UsesRootFolder_AppendsDate_FromCustomName()
    {
        ...
        string p = MainWindowViewModel.BuildBatchOutputPath(@"D:\src\clipA.mp4", "myname", root, ".mp4", true, Stamp);
    ...
    public void OutputName_SubfolderGoesUnderRoot()
    {
        ...
        string p = MainWindowViewModel.BuildBatchOutputPath(@"D:\src\clipA.mp4", @"\sub\clip", root, ".mp4", true, Stamp);
    ...
    public void BlankName_FallsBackToSourceName()
    {
        ...
        string p = MainWindowViewModel.BuildBatchOutputPath(@"D:\src\clipA.mp4", "   ", root, ".mkv", false, Stamp);
    ...
    {
        string p = MainWindowViewModel.BuildBatchOutputPath(@"D:\src\clipA.mp4", "out", null, ".mp4", false, Stamp);
    ...
    public void TraversalAndDrive_AreStripped_CannotEscapeRoot()
    {
        ...
        string p = MainWindowViewModel.BuildBatchOutputPath(@"D:\src\clipA.mp4", @"..\..\C:\evil", root, ".mp4", false, Stamp);
    ...
    {
        string p = MainWindowViewModel.BuildBatchOutputPath(@"D:\src\clipA.mp4", "name", null, ".mp4", false, Stamp);
